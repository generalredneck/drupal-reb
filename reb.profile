...
function reb_install_tasks() {
  ...
  $tasks['reb_example_store_form'] = array(
 ...
 * content on install.
 */
function reb_example_store_form() {
 ...
 */
function reb_example_store_form_submit(&$form, &$form_state) {
 ...
 */
function _reb_create_example_catalog() {
